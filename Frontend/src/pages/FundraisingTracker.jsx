                ...
                <CardContent>
                  ...
                  <Grid container spacing={2} mb={2}>
                    <Grid size={{ xs: 12, md: 3 }}>
                      <Box bgcolor="#f5f5f5" p={2} borderRadius={2}>
                        ...
                        <Typography variant="h6" fontWeight="bold">₹{(campaign.targetAmount || 0).toLocaleString("en-IN")}</Typography>
                      </Box>
                    </Grid>
                    {campaign.investorType === "multiple" && campaign.investmentRange && (
                      <Grid size={{ xs: 12, md: 3 }}>
                        <Box bgcolor="#f5f5f5" p={2} borderRadius={2}>
                          ...
                          <Typography variant="h6" fontWeight="bold">₹{(campaign.investmentRange.min || 0).toLocaleString("en-IN")} - ₹{(campaign.investmentRange.max || 0).toLocaleString("en-IN")}</Typography>
                        </Box>
                      </Grid>
                    )}
                    <Grid size={{ xs: 12, md: 3 }}>
                      <Box bgcolor="#f5f5f5" p={2} borderRadius={2}>
                        ...
                        <Typography variant="h6" fontWeight="bold">₹{(campaign.netWorthDeclaration || 0).toLocaleString("en-IN")}</Typography>
                      </Box>
                    </Grid>
                    <Grid size={{ xs: 12, md: 3 }}>
                      <Box bgcolor="#f5f5f5" p={2} borderRadius={2}>
                  ...
                  <Box>
                    ...
                    <Typography variant="body2" color="text.secondary" mt={1}>
                      ₹{(campaign.raisedAmount || 0).toLocaleString("en-IN")} raised of ₹{(campaign.targetAmount || 0).toLocaleString("en-IN")}
                    </Typography>
                  </Box>
                </CardContent>
              </Card>
            ...
            <TableBody>
              {investors.map(inv => (
                <TableRow key={inv._id} hover>
                  ...
                  <TableCell>₹{(inv.investmentSize || 0).toLocaleString("en-IN")}</TableCell>
    ...
    return (
      <Box>
        ...
        <Grid container spacing={3} mb={3}>
          {[
            { label: "Total Target",    value: `₹${totalTarget.toLocaleString("en-IN")}`,  sub: "Fundraising goal"    },
            { label: "Total Raised",    value: `₹${totalRaised.toLocaleString("en-IN")}`,  sub: "Successfully raised" },
            ...
            <Grid key={i} size={{ xs: 12, md: 3 }}>
              <Card sx={{ borderRadius: 3 }}>
                <CardContent>
                  ...
                  <Typography variant="h3" fontWeight="bold" sx={{ color: "#1f4d3a" }}>{s.value}</Typography>
                  <Typography color="text.secondary">{s.sub}</Typography>
                </CardContent>
              </Card>
            </Grid>
          ))}
  ...
  return (
    <Box p={3}>
      ...
      <Grid container spacing={3} mb={4}>
        {[
          { label: "Total Target",    value: `₹${totalTarget.toLocaleString("en-IN")}`, sub: "Fundraising goal",    icon: <AccountBalanceWalletIcon sx={{ color: "#1f4d3a" }} /> },
          { label: "Total Raised",    value: `₹${totalRaised.toLocaleString("en-IN")}`, sub: "Successfully raised", icon: <TrendingUpIcon sx={{ color: "#1f4d3a" }} /> },
